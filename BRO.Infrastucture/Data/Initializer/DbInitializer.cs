    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            if(_db.Database.CanConnect())
            {
                ...
                {
                    _userManager.CreateAsync(new ApplicationUser() { FirstName = "Admin", Email = "youtube1924@o2.pl", UserName= "youtube1924@o2.pl", EmailConfirmed=true }, "Admin123@").GetAwaiter().GetResult();
                    var newUser = _db.Users.FirstOrDefaultAsync(n => n.Email == "youtube1924@o2.pl").GetAwaiter().GetResult();
